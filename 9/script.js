...
async function getup(WhoI ){
    ...
    await setTimeout(()=>{
        if(!WhoI){
            console.log('ми трошки перепили вчора' )
            return
        }
        console.log( `Ура , я ${WhoI} , я проснувся і ще я живий`)
...
async function eat1(WhatIEat ) {
        ...
        await setTimeout(()=>{
            ...
            if (!WhatIEat){
                if (random>50){
                    console.log('відібрав ролтон у важкому бою з бомжами')
                }
                console.log('Ми бідні , голодні студенти')
                return
            }
            console.log(`Ого я навіть поїв ${WhatIEat}`)

        },randomTime)

}

async function school(Homeworks ){
        ...
        await setTimeout(()=>{
            if (!Homeworks){
                if (random>50){
                    console.log(`Юху , я списав домашку в школі . Ніхто і не замітив`)
                    return
                }
                console.log('Мене відчислили за прогули і багаточислені не зроблені ДЗ')
            }else {
                if(random>50){
                    console.log( `Я отримав 10 за ${Homeworks}`)
                    return
                }
                console.log( `У нас не перевіряли ДЗ`)
            }
        },randomTime)

}
async function PE(DoYouHaveASuit ){
        ...
        await setTimeout(()=>{
            if (DoYouHaveASuit !== true){
                if (random>50){
                    console.log( 'У вчителя добрий настрій ')
                    return
                }
                console.log('Ізбив фізрук')
                return
            }
            if (random>50){
                console.log( 'Я підтянувся 3 рази , я машина)')
                return
            }
            console.log( 'Все пройшло як завжди ')
        },randomTime)

}
async function gopStop(DoIHaveSameGorilka ){
        ...
        await setTimeout(()=>{
            if (DoIHaveSameGorilka ===true){
                if (random>50){
                    console.log( 'Віддав горілку , зате вони мене відпустили')
                    return
                }
                console.log( 'Віддав горілку і тепер я їхній друг ...')
                return
            }
            if (random>50){
                console.log('Мене ізбили' )
                return
            }
            console.log('мене ізбили і забрали гроші')
        },randomTime)

}

async function eat2(money , friend  ){
        ...
        await setTimeout(()=>{
            if (money>73){
                if (random>50){
                    console.log('Купив пюрешку з катлеткою)')
                    return
                }
                console.log( 'Купив вермішель з салатіком)')
                return
            }
            if (friend && !money){
                if (random>50){
                    console.log(`Добре що зі мною є друг ${friend} ,він купив мені порцію)`)
                    return
                }
                console.log(`Добре що зі мною є друг ${friend} , він дозволив мені доїсти за ним...`)
                return
            }
            if (random>50){
                console.log(`Відібрав їжу у бомжа`)
                return
            }
            console.log('Немає ні друзів ні грошей' )
        },randomTime)

}
async  function goToHome(money,distance){
        ...
        await setTimeout(()=>{
            if (money>30 &&distance>274){
                if (random>50){
                    console.log('Я поїхав до хати на тролейбусі')
                    return
                }
                console.log('Я поїхав до хати на маршутці')
                return
            }
            if (money>400){
                console.log('Я поїхав до хати на таксі')
                return
            }
            if (money>10){
                if (random>50){
            ...
            if (!money && distance>100){
                console.log(`Немає грошей, біжу до дому`)
                if (random>50){
                    console.log(`напали собаки`)
                    return
                }
                console.log('Я ледь добіг до дому' )
                return
            }
            console.log(`Немає грошей йду на дорогу , йду пішки`)
            if (random>50){
                console.log('настала , ніч , я не встиг дійти до хати ... Ночую на вулиці' )
                return
            }
            console.log( 'Я дійшов до дому')
